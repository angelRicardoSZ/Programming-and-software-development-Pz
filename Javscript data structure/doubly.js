...
class MyDoublyLinkedList {
    ...
    prepend(value){
        const newNode = new Node(value);
        this.head.prev = newNode; // el previo del head apunta a newnode
        newNode.next = this.head; // newnode.next apunta a head
        this.head = newNode;      // el head de la lista apunta a newnode
        this.length++;
        return this;
    }
    insert(index,value){
